...
INSERT INTO `database`.`users` (`id`, `first_name`, `last_name`, `email`, `phone_number`, `institution`, `role`) VALUES ('1', 'Christian', 'Hove', 'k@k.dk', '1', '1', '3');
INSERT INTO `database`.`users` (`id`, `first_name`, `last_name`, `email`, `phone_number`, `institution`, `role`) VALUES ('2', 'Mads', 'Balslev', 'k@k.dk', '1', '2', '2');
INSERT INTO `database`.`users` (`id`, `first_name`, `last_name`, `email`, `phone_number`, `institution`, `role`) VALUES ('3', 'Simon', 'Andersen', 'k@k.dk', '1', '3', '2');
